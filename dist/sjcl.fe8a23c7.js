...
sjcl.hash.sha256.prototype = {
  blockSize: 512, reset: function reset() {
  ...
  c: function c(a, b, _c) {
    ...
    for (d in b) {
      if (b.hasOwnProperty(d)) {
        if (_c && a[d] !== undefined && a[d] !== b[d]) throw new sjcl.exception.invalid("required parameter overridden");
        a[d] = b[d];
      }
    }return a;
  },
...
//# sourceMappingURL=/sjcl.fe8a23c7.map